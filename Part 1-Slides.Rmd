...
- The dataset contains a lot of missing values. For example, there is no data available at all for 2013, and even if there exists a table for observations in 2012, no value was recorded in it. 

- Besides these two special cases, missing values for the air temperature and the sea temperature also present in data for other years. 
